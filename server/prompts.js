...
export const DISCIPLINE = {
  ...
  quote: '素材提取的每条记忆必须带 sourceQuote 原话摘录：逐字摘自素材原文、只覆盖该条事实（≤200 字）；saidAt 必须取素材里的时间戳——原话所在消息的时间就是话语时间，不得编造或挪用其他消息的时间；内容重复既有记忆时不再登记',
